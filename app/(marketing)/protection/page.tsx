...
const privacyContent = {
    ...
    title: "Securing Your Business Intelligence: Vera's Data Protection Standards",
    sections: [
        {
            content: "Welcome to Vera Africa's Terms and Conditions (hereinafter referred to as the Terms, this Agreement, or T&C). This comprehensive document outlines the legally binding agreement between Vera Africa (hereinafter referred to as Vera, the Company, we, us, or our) and you, our valued shop owner (hereinafter referred to as the User, you, or your). The Terms set forth herein govern your access to and use of our AI-powered inventory management system and related services (collectively referred to as the Services). By accessing or using our Services, you acknowledge that you have read, understood, and agree to be bound by these Terms, which together with our Privacy Policy, constitute the entire agreement between you and Vera."
        },
        {
